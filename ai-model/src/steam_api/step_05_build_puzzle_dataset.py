...
def print_puzzle_analysis(
    merged_dataframe: pd.DataFrame,
    profiles_dataframe: pd.DataFrame,
) -> None:
    """Exibe informações sobre as subcategorias de puzzle."""
...
def build_puzzle_dataset() -> pd.DataFrame:
    """Constrói o dataset granular de puzzle."""
    ...
    print(
        "Registros de jogos de puzzle: "
        f"{len(merged_dataframe)}"
    )

    print(
        "Perfis com jogos de puzzle: "
